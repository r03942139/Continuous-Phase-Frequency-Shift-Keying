...
_PRD_swi = PRD_swi;
_TSK_idle = TSK_idle;
_tskNdkStackTest = tskNdkStackTest;
...
-stack 0x1400
MEMORY {
   CACHE_L2    : origin = 0x11800000,  len = 0x40000
   ...
   DDR_NC      : origin = 0xc4000000,  len = 0x1000000
}
/* MODULE CLK */
SECTIONS {
   .clk: {
        *(.clk) 
   } > DDR, RUN_START(CLK_A_TABBEG) 
}
_CLK_PRD = CLK_PRD;
...
SECTIONS {
   .idl: {
        *(.idl) 
   } > DDR, RUN_START(IDL_A_TABBEG)
   
   .idlcal: {
        *(.idlcal) 
   } > DDR, RUN_START(IDL_A_CALBEG) 
}
...
SECTIONS {
        ...
        /* LOG_system buffer */
        .LOG_system$buf: align = 0x100 {} > DDR
       ...
       .hst0: align = 0x4 {} > DDR
        ...
        .stack: align = 0x8 {
            ...
            *(.stack)
            ...
            _HWI_STKBOTTOM = GBL_stackbeg + 0x1400 - 8;
        ...
        .DDR_NC$heap: {
            . += 0x80000;
        } RUN_START(DDR_NC$B), RUN_START(_DDR_NC_base), RUN_SIZE(DDR_NC$L), RUN_SIZE(_DDR_NC_length) > DDR_NC
